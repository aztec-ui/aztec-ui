...
exportToGlobal('icons', {
  get() {
    return ["arrow-down","arrow-left","arrow-right","arrow-up","backward","bars","book","check","circle-check","circle-cross","circle-exclamation","close","cog","cogs","copy","download","edit","ellipsis-h","ellipsis-v","exchange","exclamation","eye","eye-close","fast-backward","fast-forward","file","floppy-disk","folder","forward","list","loading","logout","minus","mouse-pointer","move","open-folder","paste","pause","plus","question","redo","refresh","search","share","share2","shop-cart","square","three-dots","trash","triangle","undo","zoom-in","zoom-out"]
  }
})
// for Demo
/*
